...
## Update2: A user sent me a request to add the code on how to extract the clusters from the Clustermap. I created a notebook for this, please check it as well:
https://nbviewer.jupyter.org/github/arnimpdm/Blog_article_TDWI_clustermap_and_hierarchichal_clustering/blob/master/Clusters%20from%20dendrograms-for_clustermap.ipynb
